...
CREATE DBF (lcSaveTo+lcFile) FREE (groupno C(30), empid C(30), claimantid C(30), hospname C(40), hospid C(10), assigncode C(1), benftype C(3), admit C(8), discharge C(8), ;
	...
	currencyc C(3), clientname C(40), policy C(30), paid_to C(50), fxrate Y, indicator C(200), provid C(20), notify_no C(15), result C(3))
lcAlias = ALIAS()
...
SCAN 
	...
	REPLACE groupno WITH LEFT(curAviClaim.policy_group, 7), ;
		...
		policy with curAviClaim.policy  IN (lcAlias)
ENDSCAN
USE IN curAviClaim
USE IN aviHospital
***********************
