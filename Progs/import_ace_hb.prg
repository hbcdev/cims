...
*	
SELECT 0
CREATE TABLE (lcDbf) FREE (policy_no c(30),  hb_limit Y, cust_id C(20), title_nam C(20), first_nam C(40), middle_nam C(40), ;
	...
	old_plan c(20), old_prem Y, occ_code C(20), old_occ C(20), occ_clas C(20), adj_date D, ye I, st C(10), em C(10), plan C(20)) 
