...
CREATE TABLE (lcDbf) FREE (policy_no C(30), plan C(20), cust_id C(20), title C(20), fullname C(120), sex C(1), dob D, age I, ;
	...
	package C(30), paiddate D, address C(250), name C(60), surname C(60), suminsure Y, payfreq I, adddate D, planid C(10))	
IF "BKINEW" $ UPPER(lcDbf)		
...
FOR i = 1 TO lnLines
	...
	*
	...
	laData[44] = ALLTRIM(LEFT(laData[5], AT(" ", laData[5])))
	laData[45] = ALLTRIM(SUBSTR(laData[5], AT(" ", laData[5])))
	laData[46] = ldDate	
	*
	DO CASE 
	CASE SUBSTR(laData[1], 9, 1) = "7"
		laData[46] = ICASE(laData[2] = "1", 30000, laData[2] = "2", 50000, 0)
		laData[49] = ICASE(laData[2] = "1", "BKI1678", laData[2] = "2", "BKI1679", "")	
	CASE SUBSTR(laData[1], 9, 1) = "9"
		laData[46] = ICASE(laData[2] = "1", 20000, laData[2] = "2", 30000, laData[2] = "3", 40000, laData[2] = "4", 60000, 0)
		laData[49] = ICASE(laData[2] = "1", "BKI1693", laData[2] = "2", "BKI1694", laData[2] = "3", "BKI1695", laData[2] = "4", "BKI1696", "")	
	ENDCASE 		
...
*
?lcSourceFile
lcDate = SUBSTR(JUSTFNAME(lcSourceFile),11,8)
